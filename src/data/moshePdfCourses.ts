...
// Helper to create valid Chapter data structure
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          {
            id: `p-${id}-2`,
            en: `In the standardized MoSHE university curriculum, this unit provides essential competency for all freshman undergraduate students in Ethiopian universities. It bridges academic inquiry with practical problem-solving in the Ethiopian socio-economic development landscape.`,
            am: `በደረጃ በወጣው የሳይንስ እና ከፍተኛ ትምህርት ሚኒስቴር (MoSHE) የዩኒቨርሲቲ ሞጁል ውስጥ ይህ ምዕራፍ በኢትዮጵያ ዩኒቨርሲቲዎች ላሉ የመጀመሪያ ዓመት ተማሪዎች ወሳኝ ብቃትን ያሰርፃል። የአካዳሚክ ምርምርን ከአገራዊ ማህበራዊና ኢኮኖሚያዊ ልማት ጋር ያዛምዳል።`
          }
        ]
      }
    ],
...
// 2. Geography of Ethiopia and the Horn (GeES 1011)
export const geographyCourse: Course = {
  ...
  descriptionEn: 'Official MoSHE freshman module covering location, topography, drainage basins, climate, soil and vegetation, population dynamics, and economic sectors.',
  descriptionAm: 'የኢትዮጵያና የአፍሪካ ቀንድ አቀማመጥ፣ መልክአ ምድር፣ የውሃ ሀብትና ተፋሰሶች፣ አየር ንብረት፣ ህዝብ እና ኢኮኖሚያዊ እንቅስቃሴዎችን የሚያጠና ሞጁል።',
  semester: 'Semester 1',
  stream: 'Common',
  creditHours: 3,
  hasInteractiveContent: true,
  pdfModule: {
    filename: 'Geography_of_Ethiopia_and_the_Horn_MoSHE_2019.pdf',
    title: 'Geography of Ethiopia and the Horn Module',
    authorOrCommittee: 'National Geography Curriculum Committee',
    publishedYear: '2019',
    totalUnitsOrChapters: 7
  },
  metadata: { courseCode: 'GeES 1011', creditHours: 3, academicYear: 'Freshman Year' },
  chapters: [
    makePdfChapter(401, 1, 'Introduction, Location, Shape and Size of Ethiopia', 'መግቢያ፡ የኢትዮጵያ መገኛ፣ ቅርፅና ስፋት', 'Ethiopia is located in the Horn of Africa between 3°N to 15°N latitudes and 33°E to 48°E longitudes, having a compact shape and strategic geopolitical location.', 'ኢትዮጵያ በአፍሪካ ቀንድ ከ3° እስከ 15° ሰሜን ላቲትዩድ እና ከ33° እስከ 48° ምስራቅ ሎንጊትዩድ መካከል የምትገኝ፣ የተጣበበ ቅርፅ እና ስትራቴጂካዊ መገኛ ያላት ሀገር ናት።', 'MoSHE Geography Committee', [{ termEn: 'Astronomical Location', termAm: 'የስነ-ፈለክ መገኛ', defEn: 'Location defined by coordinates of latitude and longitude.', defAm: 'በኬክሮስ እና ኬንትሮስ መጋጠሚያዎች የሚገለፅ መገኛ።' }], ['Ethiopia covers 1,106,000 square kilometers.', 'Strategic proximity to the Middle East and Red Sea.'], ['ኢትዮጵያ 1.106 ሚሊዮን ካሬ ኪሎ ሜትር ስፋት አላት።', 'ለመካከለኛው ምስራቅና ቀይ ባህር ቅርብ የሆነች ስትራቴጂክ ሀገር ናት።'], [], []),
    makePdfChapter(402, 2, 'Topography and Relief of Ethiopia', 'የኢትዮጵያ መልክአ-ምድርና የመሬት አቀማመጥ', 'Ethiopia features diverse relief ranging from Ras Dejen (4,550m) to Danakil Depression (-125m), shaped by Cenozoic volcanism and rifting.', 'የኢትዮጵያ መሬት ከራስ ደጀን (4,550 ሜትር) እስከ ዳሎል/ዳናኪል ዝቅተኛ ስፍራ (-125 ሜትር) የሚደርስ ልዩነት ያለው ሲሆን በስምጥ ሸለቆ የተከፈለ ነው።', 'MoSHE Geography Committee', [{ termEn: 'Rift Valley', termAm: 'ስምጥ ሸለቆ', defEn: 'Geological depression formed by tectonic plate divergence.', defAm: 'በቴክቶኒክ ሳህኖች መራራቅ ምክንያት የተፈጠረ ታላቅ የተፈጥሮ ስምጥ።' }], ['Highlands account for 56% of the country.', 'Rift Valley divides western and southeastern plateaus.'], ['ደጋማው ክፍል 56% የሀገሪቱን ስፋት ይይዛል።', 'ስምጥ ሸለቆው የምዕራብ እና ደቡብ ምስራቅ ደጋማ ቦታዎችን ይከፍላል።'], [], []),
    makePdfChapter(403, 3, 'Drainage Systems and Water Resources', 'የውሃ ሀብትና ተፋሰሶች', 'Known as the "Water Tower of Eastern Africa", Ethiopia has 12 major river basins including the Abbay (Blue Nile), Awash, Omo, and Genale-Dawa.', 'ኢትዮጵያ "የምስራቅ አፍሪካ የውሃ ማማ" በመባል ትታወቃለች፤ አባይ፣ አዋሽ፣ ኦሞ እና ገናሌ-ዳዋን ጨምሮ 12 ዋና ዋና የተፋሰስ ሸለቆዎች አሏት።', 'MoSHE Geography Committee', [{ termEn: 'Western Drainage System', termAm: 'የምዕራብ ተፋሰስ ስርአት', defEn: 'Largest drainage system draining 60% of annual runoff toward the Nile.', defAm: '60% የሚሆነውን የሀገሪቱን ውሃ ወደ ናይል የሚያፈስ ትልቁ ተፋሰስ።' }], ['Abbay basin contributes over 68% of Lake Nasser water.', 'Hydroelectric power potential exceeds 45,000 MW.'], ['አባይ ወንዝ ወደ ግብፅ ከሚፈሰው የናይል ውሃ ከ68% በላይ ያበረክታል።', 'ሀገሪቱ ከ45,000 ሜጋ ዋት በላይ የውሃ ኃይል ማመንጨት አቅም አላት።'], [], []),
    makePdfChapter(404, 4, 'The Climate of Ethiopia and the Horn', 'የኢትዮጵያ እና የአፍሪካ ቀንድ አየር ንብረት', 'Despite tropical astronomical location, Ethiopia enjoys temperate highland climate zones modified by altitude: Bereha, Kolla, Woina Dega, Dega, and Wurch.', 'ምንም እንኳን በሞቃታማ ዞን ብትገኝም፣ በከፍታ ልዩነት ምክንያት ኢትዮጵያ በረሃ፣ ቆላ፣ ወይና ደጋ፣ ደጋ እና ውርጭ የተባሉ የአየር ንብረት ክልሎች አሏት።', 'MoSHE Geography Committee', [{ termEn: 'Woina Dega', termAm: 'ወይና ደጋ', defEn: 'Sub-tropical zone (1,500-2,300m) ideal for human settlement and agriculture.', defAm: 'ከ1,500-2,300 ሜትር ከፍታ ያለው፣ ለሰው ልጅ ኑሮና እርሻ እጅግ ተስማሚ ዞን።' }], ['ITCZ movement governs seasonal rainfall regimes.', 'Altitude is the chief climatic modifier.'], ['የITCZ እንቅስቃሴ ወቅታዊ የዝናብ ስርጭትን ይወስናል።', 'የመሬት ከፍታ ዋናው የአየር ንብረት ማስተካከያ ነው።'], [], []),
    makePdfChapter(405, 5, 'Soils, Natural Vegetation and Wildlife', 'አፈር፣ የተፈጥሮ እፅዋት እና የዱር እንስሳት', 'Ethiopia possesses high biodiversity and endemic species like the Walia Ibex, Ethiopian Wolf, and Gelada Baboon living across varying agro-ecologies.', 'ኢትዮጵያ ዋሊያ፣ ቀይ ቀበሮ እና ጭላዳ ዝንጀሮን ጨምሮ በርካታ ብርቅዬ እንስሳትና የተፈጥሮ ደኖች መኖሪያ ናት።', 'MoSHE Geography Committee', [{ termEn: 'Endemic Species', termAm: 'ብርቅዬ ዝርያዎች', defEn: 'Species native and restricted exclusively to a specific geographical area.', defAm: 'በአንድ የተወሰነ መልክአ-ምድር ብቻ የሚገኙ የተፈጥሮ ዝርያዎች።' }], ['Deforestation and soil erosion present urgent ecological threats.', 'National parks preserve irreplaceable biodiversity.'], ['የደን መጨፍጨፍና የአፈር መሸርሸር አፋጣኝ የስነ-ምህዳር ስጋት ናቸው።', 'ብሔራዊ ፓርኮች ውድ የሆኑ ብርቅዬ ዝርያዎችን ይጠብቃሉ።'], [], []),
    makePdfChapter(406, 6, 'Population of Ethiopia and the Horn', 'የኢትዮጵያ እና የአፍሪካ ቀንድ ህዝብ', 'Ethiopia is the second most populous nation in Africa with over 120 million people, a youthful demographic structure, and dynamic rural-urban migration.', 'ኢትዮጵያ ከአፍሪካ በህዝብ ብዛት ሁለተኛ ሀገር ስትሆን፣ ከ120 ሚሊዮን በላይ ህዝብ እና አብዛኛው ወጣት የሆነ የስነ-ህዝብ መዋቅር አላት።', 'MoSHE Geography Committee', [{ termEn: 'Demographic Dividend', termAm: 'የስነ-ህዝብ ትርፍ', defEn: 'Economic growth potential resulting from shifts in population age structure.', defAm: 'አምራች የሰው ኃይል በህዝብ ቁጥር ውስጥ የበላይ ሲሆን የሚገኝ የኢኮኖሚ ጥቅም።' }], ['Rapid growth demands expansion of education and jobs.', 'High density in central and northern highlands.'], ['ፈጣን የህዝብ እድገት የትምህርትና የስራ እድል ማስፋፋት ይጠይቃል።', 'በደጋማው ክፍል ከፍተኛ የህዝብ ጥግግት አለ።'], [], []),
    makePdfChapter(407, 7, 'Economic Activities in Ethiopia', 'የኢትዮጵያ ኢኮኖሚያዊ እንቅስቃሴዎች', 'Agriculture remains the backbone of the economy, complemented by expanding manufacturing, hydropower infrastructure, and the service sector.', 'ግብርና የኢትዮጵያ ኢኮኖሚ የጀርባ አጥንት ሲሆን፣ በአሁኑ ወቅት የማኑፋክቸሪንግ፣ የሃይል ማመንጫ እና የአገልግሎት ዘርፎች በከፍተኛ ፍጥነት እያደጉ ይገኛሉ።', 'MoSHE Geography Committee', [{ termEn: 'Agrarian Economy', termAm: 'የግብርና ኢኮኖሚ', defEn: 'Economy based primarily on producing crops and farmland.', defAm: 'በእርሻ እና በእንስሳት እርባታ ላይ የተመሰረተ ኢኮኖሚ።' }], ['Coffee, oilseeds, and flowers lead foreign export revenue.', 'GERD accelerates regional energy integration.'], ['ቡና፣ ቅባት እህሎች እና አበባ ዋና የውጭ ምንዛሪ ማስገኛ ናቸው።', 'ታላቁ የህዳሴ ግድብ የቀጠናውን የሃይል ትስስር ያፋጥናል።'], [], [])
  ]
};
...
export const emergingTechCourse: Course = {
  ...
  descriptionEn: 'National MoSHE freshman module introducing Fourth Industrial Revolution innovations: AI, Data Science, IoT, Cybersecurity, Cloud, and AR/VR/Robotics.',
  ...
  hasInteractiveContent: true,
  pdfModule: {
    filename: 'Emerging_Technologies_MoSHE_2019.pdf',
...
export const civicsCourse: Course = {
  ...
  badge: '6 Chapters (PDF)',
  descriptionEn: 'National MoSHE module: Ethics, morality, state and society, constitutional democracy, human rights, and rule of law in Ethiopia.',
  descriptionAm: 'ስነ-ምግባር፣ መንግስትና ማህበረሰብ፣ ህገ-መንግስታዊ ዲሞክራሲ፣ ሰብአዊ መብቶች እና የህግ የበላይነትን የሚያስተምር የMoSHE ሞጁል።',
  semester: 'Semester 2',
  stream: 'Common',
  creditHours: 3,
  hasInteractiveContent: true,
  pdfModule: {
    filename: 'Moral_and_Civic_Education_MoSHE_2019.pdf',
...
export const inclusivenessCourse: Course = {
  ...
  badge: '5 Chapters (PDF)',
  descriptionEn: 'National MoSHE module on understanding disabilities, promoting inclusive learning cultures, removing physical/pedagogical barriers, and policy frameworks.',
  descriptionAm: 'የአካል ጉዳተኝነትን እና ልዩ ፍላጎቶችን መረዳት፣ አካታች ማህበራዊና ትምህርታዊ ባህልን ማሳደግ እና የፖሊሲ ማዕቀፎችን የሚያጠና የMoSHE ሞጁል።',
  semester: 'Semester 2',
  stream: 'Common',
  creditHours: 2,
  hasInteractiveContent: true,
  pdfModule: {
    filename: 'Inclusiveness_Student_Module_MoSHE_2019.pdf',
...
export const sportsCourse: Course = {
  ...
  badge: '5 Chapters (PDF)',
  descriptionEn: 'National MoSHE module: Principles of physical fitness, cardiovascular endurance, strength training, balanced nutrition, and lifestyle stress management.',
  descriptionAm: 'የአካል ብቃት መርሆች፣ የልብና የደም ዝውውር ብቃት፣ የተመጣጠነ ምግብ እና ውጥረትን መቆጣጠር የሚያስተምር የMoSHE ሞጁል።',
  semester: 'Semester 1',
  stream: 'Common',
  creditHours: 2,
  hasInteractiveContent: true,
  pdfModule: {
    filename: 'Physical_Fitness_Student_Module_MoSHE_2019.pdf',
...
export const globalTrendsCourse: Course = {
  ...
  badge: '6 Chapters (PDF)',
  descriptionEn: 'National MoSHE module: International relations theory, foreign policy, diplomacy, African regional integration, global political economy, and contemporary security.',
  descriptionAm: 'የዓለም አቀፍ ግንኙነት ንድፈ-ሀሳብ፣ የውጭ ፖሊሲ፣ ዲፕሎማሲ፣ የአፍሪካ ቀጠናዊ ውህደት፣ እና ዓለም አቀፍ ኢኮኖሚን የሚያጠና የMoSHE ሞጁል።',
  semester: 'Semester 2',
  stream: 'Common',
  creditHours: 3,
  hasInteractiveContent: true,
  pdfModule: {
    filename: 'Global_Trends_Student_Module_MoSHE_2019.pdf',
